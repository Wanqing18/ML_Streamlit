...
import pandas as pd
#python -m streamlit run "c:/Users/Gaming/Desktop/Test Code/MLweb/Webapp1.py"
...
if choice == 'Modeling':
    ...
    if not churnRateModel.features.empty: 
        ...
        if not churnRateModel.X_train_OE.empty: 
            ...
            st.markdown('<h3>Insert learning rate</h3>',unsafe_allow_html=True)
            ...
            st.markdown('<h3>Insert Max Depth</h3>',unsafe_allow_html=True)
            ...
            st.markdown('<h3>Insert n_estimators</h3>',unsafe_allow_html=True)
            ...
            st.markdown('<h3>Insert colsample_bytree</h3>',unsafe_allow_html=True)
